<div>
    ...
    <form class="bg-gray-200 dark:bg-gray-800 rounded p-5" wire:submit="save" enctype="multipart/form-data">
        <div class="grid md:grid-cols-5 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="files">
                    بارگزاری فایل
                </label>
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <textarea id="operations" rows="4" wire:model="form.operations"
                          class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          placeholder=""></textarea>
            </div>
        </div>
